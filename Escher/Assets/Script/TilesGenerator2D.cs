...
public class TilesGenerator2D : MonoBehaviour
{
    ...
    public void WFC(){
        width = gridX/unitSize;
        length = gridZ/unitSize;
    ...
    {
        outputGrid[x, z] = Instantiate(tile.tileData.tileObject, new Vector3(x*unitSize, 0, z*unitSize), Quaternion.Euler(new Vector3(0,tile.tileData.rotationY,0)), map);
    }
    ...
    void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawWireCube(transform.position+gridOrigin+new Vector3(gridX/2f, gridY/2f, gridZ/2f)-new Vector3(unitSize/2f,unitSize/2f,unitSize/2f), new Vector3(gridX,gridY,gridZ));
    }
}
